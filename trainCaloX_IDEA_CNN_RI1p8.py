...
def generator(batch_size,nfiles):
  ...
  df = pd.read_pickle('/lustre/research/hep/jdamgov/idea_ntpl_v1/IDEA_pi_pkl3_3D_2C_RI2p2_noSci_noProp_1cmBS/GNN.pi150GeV_100.pkl.gz')
  ...
  while 1:
    ...
    if counter >= number_of_batches:
        counter = 0
        df = pd.read_pickle('/lustre/research/hep/jdamgov/idea_ntpl_v1/IDEA_pi_pkl3_3D_2C_RI2p2_noSci_noProp_1cmBS/GNN.pi150GeV_'+str(fcnt)+'.pkl.gz')
        df["Label"]=df["Label"]/1000.
        samples_per_file = len(df)
        number_of_batches = int(samples_per_file/batch_size)
...
with strategy.scope():
  ...
  dense_layer4 = tf.keras.layers.Dropout(0.3)(dense_layer4)
...
model_name = 'CNN_3D_3cm_50ps_noProp_2C_RI2p20.loss_{val_loss:01.6f}.e{epoch:03d}_pre.h5'

...
def generator(batch_size,nfiles):
  ...
  df = pd.read_pickle('/lustre/research/hep/jdamgov/idea_ntpl_v1/IDEA_pi_pkl3_3D_1C_RI1p49_zeroSci_noProp_1cmBS/GNN.pi150GeV_100.pkl.gz')
  ...
  while 1:
    ...
    if counter >= number_of_batches:
        counter = 0
        df = pd.read_pickle('/lustre/research/hep/jdamgov/idea_ntpl_v1/IDEA_pi_pkl3_3D_1C_RI1p49_zeroSci_noProp_1cmBS/GNN.pi150GeV_'+str(fcnt)+'.pkl.gz')
        df["Label"]=df["Label"]/1000.
        samples_per_file = len(df)
        number_of_batches = int(samples_per_file/batch_size)
...
input_shapes = {'points': (1400, 3), 'features': (1400, 1), 'mask': (1400, 1)}
...
model_name = 'GNN_3D_3cm_RI1p49_50ps_zeroSci_noProp_1C_1cmBS.loss_{val_loss:01.6f}.e{epoch:03d}.h5'

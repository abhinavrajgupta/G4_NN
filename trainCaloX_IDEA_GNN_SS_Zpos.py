...
def generator(batch_size,nfiles):
  ...
  while 1:
    ...
    try:
       ...
       np4=np.concatenate([np1.reshape(batch_size,4300,1),
                           npZ.reshape(batch_size,4300,1)],axis=2)
...
input_shapes = {'points': (4300, 3), 'features': (4300, 2), 'mask': (4300, 1)}
...
model_name = 'GNN_3D_3cm_SS_Zpos_50ps_noProp_1cmBS.loss_{val_loss:01.6f}.e{epoch:03d}.h5'
